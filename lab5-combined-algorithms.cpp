...
int main() {
	ifstream inputFile("lab5test_input.txt");
	ofstream outputFile("lab5test_output.txt");

	int		choice, sz;
	long	data[20], wData[20];  //maxsize = 20 change
